...
void print_x64_registers(uc_engine *uc)
{
    ...
    fprintf(stdout, REGISTER_COLOR "  RAX:" ANSI_COLOR_RESET " 0x%016"PRIx64"  " REGISTER_COLOR "RBX:" ANSI_COLOR_RESET " 0x%016"PRIx64"  " REGISTER_COLOR "RBP:" ANSI_COLOR_RESET " 0x%016"PRIx64"  " REGISTER_COLOR "RSP:" ANSI_COLOR_RESET " 0x%016"PRIx64"  " EFLAGS_COLOR, thread_state.__rax, thread_state.__rbx, thread_state.__rbp, thread_state.__rsp);
    ...
    fprintf(stdout, "\n" ANSI_COLOR_RESET);
    OUTPUT_MSG(REGISTER_COLOR "  RDI:" ANSI_COLOR_RESET " 0x%016"PRIx64"  " REGISTER_COLOR "RSI:" ANSI_COLOR_RESET " 0x%016"PRIx64"  " REGISTER_COLOR "RDX:" ANSI_COLOR_RESET " 0x%016"PRIx64"  " REGISTER_COLOR "RCX:" ANSI_COLOR_RESET " 0x%016"PRIx64"  " REGISTER_COLOR "RIP:" ANSI_COLOR_RESET " 0x%016"PRIx64, thread_state.__rdi, thread_state.__rsi, thread_state.__rdx, thread_state.__rcx, thread_state.__rip);
    OUTPUT_MSG(REGISTER_COLOR "  R8 :" ANSI_COLOR_RESET " 0x%016"PRIx64"  " REGISTER_COLOR "R9 :" ANSI_COLOR_RESET " 0x%016"PRIx64"  " REGISTER_COLOR "R10:" ANSI_COLOR_RESET " 0x%016"PRIx64"  " REGISTER_COLOR "R11:" ANSI_COLOR_RESET " 0x%016"PRIx64"  " REGISTER_COLOR "R12:" ANSI_COLOR_RESET " 0x%016"PRIx64, thread_state.__r8, thread_state.__r9, thread_state.__r10, thread_state.__r11, thread_state.__r12);
    OUTPUT_MSG(REGISTER_COLOR "  R13:" ANSI_COLOR_RESET " 0x%016"PRIx64"  " REGISTER_COLOR "R14:" ANSI_COLOR_RESET " 0x%016"PRIx64"  " REGISTER_COLOR "R15:" ANSI_COLOR_RESET " 0x%016"PRIx64"  " REGISTER_COLOR "EFLAGS:" ANSI_COLOR_RESET " 0x%016"PRIx64, thread_state.__r13, thread_state.__r14, thread_state.__r15, thread_state.__rflags);
